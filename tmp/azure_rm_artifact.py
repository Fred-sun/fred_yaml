...
DOCUMENTATION = '''
---
module: azure_rm_artifact
version_added: '2.9'
short_description: Manage Azure Artifact instance.
description:
  - 'Create, update and delete instance of Azure Artifact.'
options:
  resource_group_name:
    description:
  ...
  state:
    description:
      ...
      - >-
        Use C(present) to create or update an Artifact and C(absent) to delete
        it.
    default: present
    choices:
      - absent
...
class AzureRMArtifact(AzureRMModuleBaseExt):
    def __init__(self):
        ...
        super(AzureRMArtifact, self).__init__(derived_arg_spec=self.module_arg_spec,
    ...
    def create_update_resource(self):
        try:
            if self.to_do == Actions.Create:
                response = self.mgmt_client.artifacts.create()
            else:
                response = self.mgmt_client.artifacts.update()
    ...
    def delete_resource(self):
        try:
            response = self.mgmt_client.artifacts.delete()
