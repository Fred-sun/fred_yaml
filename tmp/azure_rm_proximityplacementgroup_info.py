    ...
    proximity_placement_group_type:
      description:
        - >-
          ...
          values are: <br><br> **Standard** : Co-locate resources within an
          Azure region or Availability Zone. <br><br> **Ultra** : For future
          use.
      returned: always
      type: str
      sample: null
    ...
    value:
      ...
      contains:
        proximity_placement_group_type:
          description:
            - >-
              Specifies the type of the proximity placement group. <br><br>
              Possible values are: <br><br> **Standard** : Co-locate resources
              within an Azure region or Availability Zone. <br><br> **Ultra** :
              For future use.
          returned: always
          type: str
          sample: null
...
class AzureRMProximityPlacementGroupInfo(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if (self.resource_group_name is not None and
            ...
            self.results['proximity_placement_groups'] = self.format_item(self.listbysubscription())
        return self.results
