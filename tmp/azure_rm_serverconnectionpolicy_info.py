...
DOCUMENTATION = '''
---
module: azure_rm_serverconnectionpolicy_info
version_added: '2.9'
short_description: Get ServerConnectionPolicy info.
description:
  - Get info of ServerConnectionPolicy.
options:
  resource_group_name:
    description:
      - >-
...
EXAMPLES = '''
    - name: Get a server's secure connection policy
      azure_rm_serverconnectionpolicy_info: 
...
server_connection_policies:
  description: >-
    ...
    ServerConnectionPolicy and the values are the facts for that
...
class AzureRMServerConnectionPolicyInfo(AzureRMModuleBase):
    def __init__(self):
        ...
        self.mgmt_client = None
        super(AzureRMServerConnectionPolicyInfo, self).__init__(self.module_arg_spec, supports_tags=True)
    ...
    def exec_module(self, **kwargs):
        ...
        if (self.resource_group_name is not None and
            ...
            self.results['server_connection_policies'] = self.format_item(self.get())
        return self.results
...
def main():
    AzureRMServerConnectionPolicyInfo()
