...
DOCUMENTATION = '''
---
module: azure_rm_servicefabricschedule_info
version_added: '2.9'
short_description: Get ServiceFabricSchedule info.
description:
  - Get info of ServiceFabricSchedule.
options:
  resource_group_name:
    description:
...
service_fabric_schedules:
  description: >-
    ...
    ServiceFabricSchedule and the values are the facts for that
...
class AzureRMServiceFabricScheduleInfo(AzureRMModuleBase):
    def __init__(self):
        ...
        self.mgmt_client = None
        super(AzureRMServiceFabricScheduleInfo, self).__init__(self.module_arg_spec, supports_tags=True)
    ...
    def exec_module(self, **kwargs):
        ...
        if (self.resource_group_name is not None and
            ...
            self.service_fabric_name is not None and
            self.name is not None):
            self.results['service_fabric_schedules'] = self.format_item(self.get())
        elif (self.resource_group_name is not None and
              self.lab_name is not None and
              self.user_name is not None and
              self.service_fabric_name is not None):
            self.results['service_fabric_schedules'] = self.format_item(self.list())
        return self.results
    ...
    def list(self):
        ...
        try:
            response = self.mgmt_client.service_fabric_schedules.list(resource_group_name=self.resource_group_name,
                                                                      lab_name=self.lab_name,
                                                                      user_name=self.user_name,
                                                                      service_fabric_name=self.service_fabric_name,
                                                                      expand=self.expand,
...
def main():
    AzureRMServiceFabricScheduleInfo()
