      ...
      mode:
        description:
          - >-
            ...
            control the application of updates to virtual machines in the scale
          ...
          enable_automatic_os_upgrade:
            description:
              - >-
                ...
                the OS image becomes available. Default value is false. <br><br>
            ...
            description:
              - >-
                ...
                **Minimum-length (Linux):** 6 characters <br><br> **Max-length
                ...
                "iloveyou!" <br><br> For resetting the password, see [How to
          ...
          custom_data:
            description:
              - >-
                ...
                array is 65535 bytes. <br><br> For using cloud-init for your VM,
              ...
              provision_vm_agent:
                description:
                  - >-
                    ...
                    Agent is installed on the VM so that extensions can be added
                    to the VM later.
                type: bool
              enable_automatic_updates:
                description:
                  - >-
                    ...
                    Windows virtual machine. Default value is true. <br><br> For
                    virtual machine scale sets, this property can be updated and
                  ...
                  patch_mode:
                    description:
                      - >-
                        ...
                        **Manual** - You  control the application of patches to
                        a virtual machine. You do this by applying patches
                        manually inside the VM. In this mode, automatic updates
                        are disabled; the property
                      ...
                      protocol:
                        description:
                          - >-
                            ...
                            Possible values are: <br>**http** <br><br> **https**
                        type: sealed-choice
                      certificate_url:
                        description:
                          - >-
                      ...
                      key_data:
                        description:
                          - >-
                            ...
                            2048-bit and in ssh-rsa format. <br><br> For
                            creating ssh keys, see [Create SSH keys on Linux and
              ...
              caching:
                description:
                  - >-
                    ...
                    are: <br><br> **None** <br><br> **ReadOnly** <br><br>
              ...
              create_option:
                description:
                  - >-
                    ...
                    be created.<br><br> The only allowed value is: **FromImage**
              ...
              disk_size_gb:
                description:
                  - >-
                    ...
                    the disk in a virtual machine image. <br><br> This value
              ...
              os_type:
                description:
                  - >-
                    ...
                    a specialized VHD. <br><br> Possible values are: <br><br>
                    **Windows** <br><br> **Linux**
                type: sealed-choice
              image:
                description:
          ...
          data_disks:
            description:
              - >-
                ...
                virtual machines in the scale set. <br><br> For more information
              ...
              disk_size_gb:
                description:
                  - >-
                    ...
                    virtual machine image. <br><br> This value cannot be larger
                    than 1023 GB
                type: integer
              managed_disk:
                description:
          ...
          boot_diagnostics:
            description:
              - >-
                ...
                Console Output and Screenshot to diagnose VM status. <br><br>
                You can easily view the output of your console log. <br><br>
      ...
      eviction_policy:
        description:
          - >-
            ...
            is 2019-03-01. <br><br>For Azure Spot scale sets, both 'Deallocate'
            and 'Delete' are supported and the minimum api-version is
            2017-10-30-preview.
        type: str
        choices:
          - Deallocate
          ...
          max_price:
            description:
              - >-
                ...
                size. Also, the prices are compared at the time of create/update
                of Azure Spot VM/VMSS and the operation will only succeed if 
                the maxPrice is greater than the current Azure Spot price.
                <br><br> The maxPrice will also be used for evicting a Azure
                Spot VM/VMSS if the current Azure Spot price goes beyond the
                maxPrice after creation of VM/VMSS. <br><br> Possible values
                are: <br><br> - Any decimal value greater than zero. Example:
                0.01538 <br><br> -1 – indicates default price to be up-to
                on-demand. <br><br> You can set the maxPrice to -1 to indicate
                that the Azure Spot VM/VMSS should not be evicted for price
                reasons. Also, the default max price is -1 if it is not provided
                by you. <br><br>Minimum api-version: 2019-03-01.
            type: number
      ...
      rules:
        description:
          - >-
            ...
            ones that are not protected from scale-in. <br><br> **OldestVM**
            When a virtual machine scale set is being scaled-in, the oldest
            virtual machines that are not protected from scale-in will be chosen
            for removal. For zonal virtual machine scale sets, the scale set
            will first be balanced across zones. Within each zone, the oldest
            virtual machines that are not protected will be chosen for removal.
            <br><br> **NewestVM** When a virtual machine scale set is being
            scaled-in, the newest virtual machines that are not protected from
            ...
            zone, the newest virtual machines that are not protected will be
          ...
          provision_vm_agent:
            description:
              - >-
                ...
                the virtual machine. <br><br> When this property is not
          ...
          enable_automatic_updates:
            description:
              - >-
                ...
                virtual machine. Default value is true. <br><br> For virtual
              ...
              patch_mode:
                description:
                  - >-
                    Specifies the mode of in-guest patching to IaaS virtual
                    machine.<br /><br /> Possible values are:<br /><br />
                    **Manual** - You  control the application of patches to a
                    virtual machine. You do this by applying patches manually
                    inside the VM. In this mode, automatic updates are disabled;
                    the property WindowsConfiguration.enableAutomaticUpdates
                    must be false<br /><br /> **AutomaticByOS** - The virtual
                    machine will automatically be updated by the OS. The
                    property WindowsConfiguration.enableAutomaticUpdates must be
                    true. <br /><br /> ** AutomaticByPlatform** - the virtual
                    machine will automatically updated by the platform. The
                  ...
                  key_data:
                    description:
                      - >-
                        ...
                        and in ssh-rsa format. <br><br> For creating ssh keys,
              ...
              certificate_store:
                description:
                  - >-
                    ...
                    LocalMachine account. <br><br>For Linux VMs, the certificate
                    file is placed under the /var/lib/waagent directory, with
                    the file name &lt;UppercaseThumbprint&gt;.crt for the X509
                    certificate file and &lt;UppercaseThumbprint&gt;.prv for
          ...
          disk_size_gb:
            description:
              - >-
                ...
                virtual machine image. <br><br> This value cannot be larger than
                1023 GB
            type: integer
          image:
            description:
          ...
          disk_mbps_read_write:
            description:
              - >-
                ...
                Should be used only when StorageAccountType is UltraSSD_LRS. If
          ...
          ip_configurations:
            ...
            suboptions:
              ...
              primary:
                description:
                  - >-
                    Specifies the primary IP Configuration in case the network
      ...
      encryption_at_host:
        description:
          - >-
            ...
            including Resource/Temp disk at host itself. <br><br> Default: The
    ...
    suboptions:
      boot_diagnostics:
        description:
          - >-
            Boot Diagnostics is a debugging feature which allows you to view
            Console Output and Screenshot to diagnose VM status. <br><br> You
            can easily view the output of your console log. <br><br> Azure also
          ...
          storage_uri:
            description:
              - >-
                ...
                and screenshot. <br><br>If storageUri is not specified while
      ...
      extensions_time_budget:
        description:
          - >-
            ...
            minutes (PT1H30M). <br><br> Minimum api-version: 2020-06-01
        type: str
  license_type:
    description:
      ...
      max_price:
        description:
          - >-
            ...
            compared with the current Azure Spot price for the VM size. Also,
            the prices are compared at the time of create/update of Azure Spot
            VM/VMSS and the operation will only succeed if  the maxPrice is
            greater than the current Azure Spot price. <br><br> The maxPrice
            will also be used for evicting a Azure Spot VM/VMSS if the current
            Azure Spot price goes beyond the maxPrice after creation of VM/VMSS.
            <br><br> Possible values are: <br><br> - Any decimal value greater
            than zero. Example: 0.01538 <br><br> -1 – indicates default price to
            be up-to on-demand. <br><br> You can set the maxPrice to -1 to
      ...
      enable_automatic_os_upgrade:
        description:
          - >-
            ...
            OS image becomes available. Default value is false. <br><br> If this
      ...
      contains:
          ...
          description:
            - >-
              ...
              **Minimum-length (Linux):** 6 characters <br><br> **Max-length
              ...
              <br><br> For resetting the password, see [How to reset the Remote
            ...
            provision_vm_agent:
              description:
                - >-
                  ...
                  on the virtual machine. <br><br> When this property is not
                  specified in the request body, default behavior is to set it
                  to true.  This will ensure that VM Agent is installed on the
                  ...
                  description:
                    - >-
                      ...
                      **Manual** - You  control the application of patches to a
                      ...
                      WindowsConfiguration.enableAutomaticUpdates must be true.
                      <br /><br /> ** AutomaticByPlatform** - the virtual
                      machine will automatically updated by the platform. The
                      properties provisionVMAgent and
                      WindowsConfiguration.enableAutomaticUpdates must be true 
                  returned: always
        ...
        linux_configuration:
          description:
            - >-
              Specifies the Linux operating system settings on the virtual
              machine. <br><br>For a list of supported Linux distributions, see
                    ...
                    key_data:
                      description:
                        - >-
                          ...
                          ssh keys, see [Create SSH keys on Linux and Mac for
                          Linux VMs in
                          Azure](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-linux-mac-create-ssh-keys?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
                      returned: always
                      type: str
                ...
                certificate_store:
                  description:
                    - >-
                      ...
                      Virtual Machine to which the certificate should be added.
                      The specified certificate store is implicitly in the
                      LocalMachine account. <br><br>For Linux VMs, the
                      certificate file is placed under the /var/lib/waagent
                      directory, with the file name
                      &lt;UppercaseThumbprint&gt;.crt for the X509 certificate
            ...
            create_option:
              description:
                - >-
                  ...
                  \u2013 This value is used when you are using an image to
                  create the virtual machine. If you are using a platform image,
                  you also use the imageReference element described above. If
                  you are using a marketplace image, you  also use the plan
                ...
                placement:
                  description:
                    - >-
                      Specifies the ephemeral disk placement for operating
                      system disk.<br><br> Possible values are: <br><br>
                      **CacheDisk** <br><br> **ResourceDisk** <br><br> Default:
                      **CacheDisk** if one is configured for the VM size
                      otherwise **ResourceDisk** is used.<br><br> Refer to VM
            ...
            disk_size_gb:
              description:
                - >-
                  ...
                  a virtual machine image. <br><br> This value cannot be larger
                  than 1023 GB
              returned: always
              type: integer
              sample: null
            os_type:
              description:
                - >-
                  ...
                  specialized VHD. <br><br> Possible values are: <br><br>
                  **Windows** <br><br> **Linux**
              returned: always
              type: sealed-choice
              sample: null
        ...
        boot_diagnostics:
          description:
            - >-
              Boot Diagnostics is a debugging feature which allows you to view
              Console Output and Screenshot to diagnose VM status. <br><br> You
              can easily view the output of your console log. <br><br> Azure
          ...
          contains:
            ...
            storage_uri:
              description:
                - >-
                  Uri of the storage account to use for placing the console
                  output and screenshot. <br><br>If storageUri is not specified
        ...
        extensions_time_budget:
          description:
            - >-
              ...
              90 minutes (PT1H30M). <br><br> Minimum api-version: 2020-06-01
          returned: always
          type: str
          sample: null
    license_type:
        ...
        max_price:
          description:
            - >-
              ...
              will be compared with the current Azure Spot price for the VM
              size. Also, the prices are compared at the time of create/update
              of Azure Spot VM/VMSS and the operation will only succeed if  the
              maxPrice is greater than the current Azure Spot price. <br><br>
              The maxPrice will also be used for evicting a Azure Spot VM/VMSS
              if the current Azure Spot price goes beyond the maxPrice after
              creation of VM/VMSS. <br><br> Possible values are: <br><br> - Any
              decimal value greater than zero. Example: 0.01538 <br><br> -1 –
              indicates default price to be up-to on-demand. <br><br> You can
              ...
              price is -1 if it is not provided by you. <br><br>Minimum
    ...
    rules:
      description:
        - >-
          ...
          virtual machines chosen for removal will be the newest ones that are
          not protected from scale-in. <br><br> **OldestVM** When a virtual
          machine scale set is being scaled-in, the oldest virtual machines that
          ...
          across zones. Within each zone, the oldest virtual machines that are
          not protected will be chosen for removal. <br><br> **NewestVM** When a
