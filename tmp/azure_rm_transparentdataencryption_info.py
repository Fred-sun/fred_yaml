...
DOCUMENTATION = '''
---
module: azure_rm_transparentdataencryption_info
version_added: '2.9'
short_description: Get TransparentDataEncryption info.
description:
  - Get info of TransparentDataEncryption.
options:
  resource_group_name:
    description:
      - >-
...
EXAMPLES = '''
    - name: Get a database's transparent data encryption configuration
      azure_rm_transparentdataencryption_info: 
...
transparent_data_encryptions:
  description: >-
    ...
    TransparentDataEncryption and the values are the facts for that
...
class AzureRMTransparentDataEncryptionInfo(AzureRMModuleBase):
    def __init__(self):
        ...
        self.mgmt_client = None
        super(AzureRMTransparentDataEncryptionInfo, self).__init__(self.module_arg_spec, supports_tags=True)
    ...
    def exec_module(self, **kwargs):
        ...
        if (self.resource_group_name is not None and
            ...
            self.results['transparent_data_encryptions'] = self.format_item(self.get())
        return self.results
...
def main():
    AzureRMTransparentDataEncryptionInfo()
