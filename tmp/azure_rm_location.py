...
class AzureRMLocation(AzureRMModuleBaseExt):
    ...
    def create_update_resource(self):
        try:
            if self.to_do == Actions.Create:
                response = self.mgmt_client.locations.create()
            else:
                response = self.mgmt_client.locations.update()
    ...
    def delete_resource(self):
        try:
            response = self.mgmt_client.locations.delete()
    ...
    def get_resource(self):
        try:
            response = self.mgmt_client.locations.get()
        except CloudError as e:
            return False
        return response.as_dict()
