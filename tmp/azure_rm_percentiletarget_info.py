...
DOCUMENTATION = '''
---
module: azure_rm_percentiletarget_info
version_added: '2.9'
...
EXAMPLES = '''
    - name: CosmosDBDatabaseAccountRegionGetMetrics
      azure_rm_percentiletarget_info: 
        account_name: ddb1
...
class AzureRMPercentileTargetInfo(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if (self.resource_group_name is not None and
            ...
            self.results['percentile_target'] = self.format_item(self.listmetric())
        return self.results
    ...
    def listmetric(self):
        ...
        try:
            response = self.mgmt_client.percentile_target.list_metric(resource_group_name=self.resource_group_name,
