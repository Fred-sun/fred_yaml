...
DOCUMENTATION = '''
---
module: azure_rm_guestconfigurationhcrpassignment_info
version_added: '2.9'
short_description: Get GuestConfigurationHCRPAssignment info.
description:
  - Get info of GuestConfigurationHCRPAssignment.
options:
  resource_group_name:
    description:
...
EXAMPLES = '''
    - name: Get a guest configuration assignment
      azure_rm_guestconfigurationhcrpassignment_info: 
...
RETURN = '''
guest_configuration_hcrpassignments:
  description: >-
    A list of dict results where the key is the name of the
    GuestConfigurationHCRPAssignment and the values are the facts for that
...
class AzureRMGuestConfigurationHCRPAssignmentInfo(AzureRMModuleBase):
    def __init__(self):
        ...
        self.mgmt_client = None
        super(AzureRMGuestConfigurationHCRPAssignmentInfo, self).__init__(self.module_arg_spec, supports_tags=True)
    ...
    def exec_module(self, **kwargs):
        ...
        if (self.resource_group_name is not None and
            ...
            self.results['guest_configuration_hcrpassignments'] = self.format_item(self.get())
        elif (self.resource_group_name is not None and
              self.machine_name is not None):
            self.results['guest_configuration_hcrpassignments'] = self.format_item(self.list())
        return self.results
    ...
    def list(self):
        ...
        try:
            response = self.mgmt_client.guest_configuration_hcrpassignments.list(resource_group_name=self.resource_group_name,
                                                                                 machine_name=self.machine_name)
        except CloudError as e:
            self.log('Could not get info for @(Model.ModuleOperationNameUpper).')
...
def main():
    AzureRMGuestConfigurationHCRPAssignmentInfo()
