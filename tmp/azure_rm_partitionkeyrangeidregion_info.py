...
DOCUMENTATION = '''
---
module: azure_rm_partitionkeyrangeidregion_info
version_added: '2.9'
...
EXAMPLES = '''
    - name: CosmosDBDatabaseAccountRegionGetMetrics
      azure_rm_partitionkeyrangeidregion_info: 
        account_name: ddb1
...
class AzureRMPartitionKeyRangeIdRegionInfo(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if (self.resource_group_name is not None and
            ...
            self.results['partition_key_range_id_region'] = self.format_item(self.listmetric())
        return self.results
    ...
    def listmetric(self):
        ...
        try:
            response = self.mgmt_client.partition_key_range_id_region.list_metric(resource_group_name=self.resource_group_name,
