...
class AzureRMQueue(AzureRMModuleBaseExt):
    def __init__(self):
    ...
    def delete_resource(self):
        try:
            response = self.mgmt_client.queue.delete(resource_group_name=self.resource_group_name,
                                                     account_name=self.account_name,
                                                     queue_name=self.queue_name)
