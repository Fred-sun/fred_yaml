            ...
            enable_automatic_os_upgrade:
              description:
                - >-
                  ...
                  false. <br><br> If this is set to true for Windows based scale
                  sets,
              ...
              description:
                - >-
                  ...
                  **Minimum-length (Linux):** 6 characters <br><br> **Max-length
                  ...
                  a special character (Regex match [\W_]) <br><br> **Disallowed
                  values:** "abc@123", "P@$$w0rd", "P@ssw0rd", "P@ssword123",
                  "Pa$$word", "pass@word1", "Password!", "Password1",
                  "Password22", "iloveyou!" <br><br> For resetting the password,
                  see [How to reset the Remote Desktop service or its login
            ...
            custom_data:
              description:
                - >-
                  ...
                  array is 65535 bytes. <br><br> For using cloud-init for your
                ...
                provision_vm_agent:
                  description:
                    - >-
                      ...
                      provisioned on the virtual machine. <br><br> When this
                      property is not specified in the request body, default
                      behavior is to set it to true.  This will ensure that VM
                      Agent is installed on the VM so that extensions can be
                ...
                enable_automatic_updates:
                  description:
                    - >-
                      ...
                      Windows virtual machine. Default value is true. <br><br>
                      For virtual machine scale sets, this property can be
                    ...
                    patch_mode:
                      description:
                        - >-
                          ...
                          virtual machine.<br /><br /> Possible values are:<br
                          /><br /> **Manual** - You  control the application of
                          patches to a virtual machine. You do this by applying
                          patches manually inside the VM. In this mode,
                          automatic updates are disabled; the property
                          WindowsConfiguration.enableAutomaticUpdates must be
                          false<br /><br /> **AutomaticByOS** - The virtual
                          machine will automatically be updated by the OS. The
                          property WindowsConfiguration.enableAutomaticUpdates
                          must be true. <br /><br /> ** AutomaticByPlatform** -
                    ...
                    listeners:
                      ...
                      contains:
                        protocol:
                          description:
                            - >-
                              Specifies the protocol of WinRM listener. <br><br>
                              Possible values are: <br>**http** <br><br>
                              **https**
                          returned: always
                          type: sealed-choice
                          sample: null
                        certificate_url:
                          description:
                            - >-
                              ...
                              which is encoded in UTF-8: <br><br> {<br> 
            ...
            linux_configuration:
              description:
                - >-
                  ...
                  machine. <br><br>For a list of supported Linux distributions,
                        ...
                        key_data:
                          description:
                            - >-
                              ...
                              least 2048-bit and in ssh-rsa format. <br><br> For
                              creating ssh keys, see [Create SSH keys on Linux
                              and Mac for Linux VMs in
                    ...
                    certificate_store:
                      description:
                        - >-
                          ...
                          in the LocalMachine account. <br><br>For Linux VMs,
                          the certificate file is placed under the
                          /var/lib/waagent directory, with the file name
                          &lt;UppercaseThumbprint&gt;.crt for the X509
                          certificate file and &lt;UppercaseThumbprint&gt;.prv
                          for private key. Both of these files are .pem
                          formatted.
                      returned: always
                      type: str
                      sample: null
                ...
                exact_version:
                  description:
                    - >-
                      ...
                      machine. This readonly field differs from 'version', only
            ...
            os_disk:
              description:
                - >-
                  ...
                  the virtual machines in the scale set. <br><br> For more
              ...
              contains:
                ...
                caching:
                  description:
                    - >-
                      Specifies the caching requirements. <br><br> Possible
                ...
                create_option:
                  description:
                    - >-
                      ...
                      be created.<br><br> The only allowed value is:
                      **FromImage** \u2013 This value is used when you are using
                      an image to create the virtual machine. If you are using a
                      platform image, you also use the imageReference element
                      described above. If you are using a marketplace image,
                    ...
                    placement:
                      description:
                        - >-
                          ...
                          system disk.<br><br> Possible values are: <br><br>
                          **CacheDisk** <br><br> **ResourceDisk** <br><br>
                          Default: **CacheDisk** if one is configured for the VM
                          size otherwise **ResourceDisk** is used.<br><br> Refer
                          to VM size documentation for Windows VM at
                ...
                os_type:
                  description:
                    - >-
                      ...
                      user-image or a specialized VHD. <br><br> Possible values
                ...
                disk_size_gb:
                  description:
                    - >-
                      ...
                      in a virtual machine image. <br><br> This value cannot be
                      larger than 1023 GB
                  returned: always
                  type: integer
                  sample: null
            ...
            encryption_at_host:
              description:
                - >-
                  ...
                  disks including Resource/Temp disk at host itself. <br><br>
            ...
            boot_diagnostics:
              description:
                - >-
                  ...
                  <br><br> You can easily view the output of your console log.
                  <br><br> Azure also enables you to see a screenshot of the VM
                  from the hypervisor.
              returned: always
              type: dict
              sample: null
                ...
                storage_uri:
                  description:
                    - >-
                      ...
                      output and screenshot. <br><br>If storageUri is not
                      specified while enabling boot diagnostics, managed storage
                      will be used.
                  returned: always
                  type: str
                  sample: null
            ...
            extensions_time_budget:
              description:
                - >-
                  ...
                  default value is 90 minutes (PT1H30M). <br><br> Minimum
        ...
        license_type:
          description:
            - >-
              ...
              element is included in a request for an update, the value must
              match the initial value. This value cannot be updated. <br><br>
        ...
        eviction_policy:
          description:
            - >-
              ...
              and Azure Spot scale set. <br><br>For Azure Spot virtual machines,
            ...
            max_price:
              description:
                - >-
                  ...
                  Spot VM/VMSS. This price is in US Dollars. <br><br> This price
                  will be compared with the current Azure Spot price for the VM
                  size. Also, the prices are compared at the time of
                  create/update of Azure Spot VM/VMSS and the operation will
                  only succeed if  the maxPrice is greater than the current
                  Azure Spot price. <br><br> The maxPrice will also be used for
                  evicting a Azure Spot VM/VMSS if the current Azure Spot price
                  goes beyond the maxPrice after creation of VM/VMSS. <br><br>
                  Possible values are: <br><br> - Any decimal value greater than
                  zero. Example: 0.01538 <br><br> -1 – indicates default price
                  to be up-to on-demand. <br><br> You can set the maxPrice to -1
                  to indicate that the Azure Spot VM/VMSS should not be evicted
                  for price reasons. Also, the default max price is -1 if it is
        ...
        rules:
          description:
            - >-
              ...
              set. <br><br> Possible values are: <br><br> **Default** When a
              virtual machine scale set is scaled in, the scale set will first
              be balanced across zones if it is a zonal scale set. Then, it will
              be balanced across Fault Domains as far as possible. Within each
              Fault Domain, the virtual machines chosen for removal will be the
              newest ones that are not protected from scale-in. <br><br>
              **OldestVM** When a virtual machine scale set is being scaled-in,
              ...
              chosen for removal. <br><br> **NewestVM** When a virtual machine
              scale set is being scaled-in, the newest virtual machines that are
              not protected from scale-in will be chosen for removal. For zonal
            ...
            tier:
              description:
                - >-
                  ...
                  /><br /> Possible Values:<br /><br /> **Standard**<br /><br />
                  **Basic**
              returned: always
              type: str
              sample: null
            ...
            mode:
              description:
                - >-
                  ...
                  scale set.<br /><br /> Possible values are:<br /><br />
                  **Manual** - You  control the application of updates to
                  virtual machines in the scale set. You do this by using the
                  manualUpgrade action.<br /><br /> **Automatic** - All virtual
                  machines in the scale set are  automatically updated at the
                  same time.
              returned: always
              type: sealed-choice
              sample: null
                ...
                enable_automatic_os_upgrade:
                  description:
                    - >-
                      ...
                      value is false. <br><br> If this is set to true for
                  ...
                  description:
                    - >-
                      ...
                      **Complexity requirements:** 3 out of 4 conditions below
                      ...
                      values:** "abc@123", "P@$$w0rd", "P@ssw0rd",
                      "P@ssword123", "Pa$$word", "pass@word1", "Password!",
                      "Password1", "Password22", "iloveyou!" <br><br> For
                ...
                custom_data:
                  description:
                    - >-
                      ...
                      using cloud-init for your VM, see [Using cloud-init to
                  ...
                  contains:
                    provision_vm_agent:
                      description:
                        - >-
                          ...
                          provisioned on the virtual machine. <br><br> When this
                          property is not specified in the request body, default
                          behavior is to set it to true.  This will ensure that
                          VM Agent is installed on the VM so that extensions can
                    ...
                    enable_automatic_updates:
                      description:
                        - >-
                          ...
                          <br><br> For virtual machine scale sets, this property
                          can be updated and updates will take effect on OS
                          reprovisioning.
                      returned: always
                      type: bool
                      sample: null
                    time_zone:
                      description:
                        - >-
                          Specifies the time zone of the virtual machine. e.g.
                          "Pacific Standard Time". <br><br> Possible values can
                          be
                          [TimeZoneInfo.Id](https://docs.microsoft.com/en-us/dotnet/api/system.timezoneinfo.id?#System_TimeZoneInfo_Id)
                          value from time zones returned by
                          [TimeZoneInfo.GetSystemTimeZones](https://docs.microsoft.com/en-us/dotnet/api/system.timezoneinfo.getsystemtimezones).
                      ...
                      contains:
                        patch_mode:
                          description:
                            - >-
                              Specifies the mode of in-guest patching to IaaS
                              virtual machine.<br /><br /> Possible values
                              are:<br /><br /> **Manual** - You  control the
                              application of patches to a virtual machine. You
                              do this by applying patches manually inside the
                              VM. In this mode, automatic updates are disabled;
                              the property
                              WindowsConfiguration.enableAutomaticUpdates must
                              be false<br /><br /> **AutomaticByOS** - The
                              virtual machine will automatically be updated by
                              the OS. The property
                              WindowsConfiguration.enableAutomaticUpdates must
                              be true. <br /><br /> ** AutomaticByPlatform** -
                              the virtual machine will automatically updated by
                            ...
                            certificate_url:
                              description:
                                - >-
                                  ...
                                  Object which is encoded in UTF-8: <br><br>
                                  {<br> 
                                  "data":"<Base64-encoded-certificate>",<br> 
                                  "dataType":"pfx",<br> 
                                  "password":"<pfx-file-password>"<br>}
                ...
                linux_configuration:
                  description:
                    - >-
                      ...
                      virtual machine. <br><br>For a list of supported Linux
                            ...
                            key_data:
                              description:
                                - >-
                                  ...
                                  format. <br><br> For creating ssh keys, see
                                  [Create SSH keys on Linux and Mac for Linux
                                  VMs in
                                  Azure](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-linux-mac-create-ssh-keys?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
                              returned: always
                              type: str
                        ...
                        certificate_store:
                          description:
                            - >-
                              ...
                              <br><br>For Linux VMs, the certificate file is
                              placed under the /var/lib/waagent directory, with
                              the file name &lt;UppercaseThumbprint&gt;.crt for
                    ...
                    exact_version:
                      description:
                        - >-
                          Specifies in decimal numbers, the version of platform
                          image or marketplace image used to create the virtual
                          machine. This readonly field differs from 'version',
                          only if the value specified in 'version' field is
                          'latest'.
                      returned: always
                      type: str
                      sample: null
                os_disk:
                  description:
                    - >-
                      ...
                      by the virtual machines in the scale set. <br><br> For
                      more information about disks, see [About disks and VHDs
                      for Azure virtual
                      machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
                  returned: always
                  type: dict
                    ...
                    create_option:
                      description:
                        - >-
                          ...
                          should be created.<br><br> The only allowed value is:
                          **FromImage** \u2013 This value is used when you are
                          using an image to create the virtual machine. If you
                          are using a platform image, you also use the
                          imageReference element described above. If you are
                          using a marketplace image, you  also use the plan
                        ...
                        placement:
                          description:
                            - >-
                              ...
                              operating system disk.<br><br> Possible values
                              are: <br><br> **CacheDisk** <br><br>
                              **ResourceDisk** <br><br> Default: **CacheDisk**
                              if one is configured for the VM size otherwise
                    ...
                    disk_size_gb:
                      description:
                        - >-
                          ...
                          size of the disk in a virtual machine image. <br><br>
                ...
                data_disks:
                  description:
                    - >-
                      ...
                      to the virtual machines in the scale set. <br><br> For
                      more information about disks, see [About disks and VHDs
                      for Azure virtual
                      machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
                  returned: always
                ...
                encryption_at_host:
                  description:
                    - >-
                      ...
                      itself. <br><br> Default: The Encryption at host will be
                ...
                boot_diagnostics:
                  description:
                    - >-
                      ...
                      status. <br><br> You can easily view the output of your
                      console log. <br><br> Azure also enables you to see a
                    ...
                    storage_uri:
                      description:
                        - >-
                          ...
                          console output and screenshot. <br><br>If storageUri
                          is not specified while enabling boot diagnostics,
            ...
            license_type:
              description:
                - >-
                  ...
                  licensed on-premises. This element is only used for images
                  that contain the Windows Server operating system. <br><br>
                  Possible values are: <br><br> Windows_Client <br><br>
                  Windows_Server <br><br> If this element is included in a
                  request for an update, the value must match the initial value.
                  This value cannot be updated. <br><br> For more information,
            ...
            eviction_policy:
              description:
                - >-
                  ...
                  machine and Azure Spot scale set. <br><br>For Azure Spot
                  virtual machines, both 'Deallocate' and 'Delete' are supported
                  and the minimum api-version is 2019-03-01. <br><br>For Azure
                  Spot scale sets, both 'Deallocate' and 'Delete' are supported
                  and the minimum api-version is 2017-10-30-preview.
              returned: always
              type: str
              sample: null
            billing_profile:
                ...
                max_price:
                  description:
                    - >-
                      ...
                      Azure Spot VM/VMSS. This price is in US Dollars. <br><br>
                      This price will be compared with the current Azure Spot
                      price for the VM size. Also, the prices are compared at
                      the time of create/update of Azure Spot VM/VMSS and the
                      operation will only succeed if  the maxPrice is greater
                      than the current Azure Spot price. <br><br> The maxPrice
                      will also be used for evicting a Azure Spot VM/VMSS if the
                      current Azure Spot price goes beyond the maxPrice after
                      creation of VM/VMSS. <br><br> Possible values are:
                      ...
                      is not provided by you. <br><br>Minimum api-version:
                      2019-03-01.
                  returned: always
                  type: number
                  sample: null
        ...
        host_group:
          description:
            - >-
              ...
              virtual machine scale set resides in. <br><br>Minimum api-version:
              2020-06-01.
          returned: always
          type: dict
          sample: null
            ...
            rules:
              description:
                - >-
                  ...
                  scale set. <br><br> Possible values are: <br><br> **Default**
                  When a virtual machine scale set is scaled in, the scale set
                  will first be balanced across zones if it is a zonal scale
                  set. Then, it will be balanced across Fault Domains as far as
                  possible. Within each Fault Domain, the virtual machines
                  chosen for removal will be the newest ones that are not
                  protected from scale-in. <br><br> **OldestVM** When a virtual
                  ...
                  set will first be balanced across zones. Within each zone, the
                  oldest virtual machines that are not protected will be chosen
