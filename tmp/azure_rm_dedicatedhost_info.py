    ...
    instance_view:
      ...
      contains:
        asset_id:
          description:
            - >-
              Specifies the unique id of the dedicated physical machine on which
              the dedicated host resides.
          returned: always
          type: str
          sample: null
        available_capacity:
    ...
    value:
      ...
      contains:
        ...
        virtual_machines:
          description:
            - >-
              A list of references to all virtual machines in the Dedicated
              Host.
          returned: always
          type: list
          sample: null
        ...
        license_type:
          description:
            - >-
              ...
              VMs deployed on the dedicated host. <br><br> Possible values are:
              <br><br> **None** <br><br> **Windows_Server_Hybrid** <br><br>
              **Windows_Server_Perpetual** <br><br> Default: **None**
          returned: always
          type: sealed-choice
          sample: null
