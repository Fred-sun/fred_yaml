...
DOCUMENTATION = '''
---
module: azure_rm_transformation_info
version_added: '2.9'
short_description: Get Transformation info.
description:
  - Get info of Transformation.
options:
  resource_group_name:
    description:
...
transformations:
  description: >-
    A list of dict results where the key is the name of the Transformation and
    the values are the facts for that Transformation.
  returned: always
  type: complex
  contains:
    id:
...
class AzureRMTransformationInfo(AzureRMModuleBase):
    def __init__(self):
        ...
        self.mgmt_client = None
        super(AzureRMTransformationInfo, self).__init__(self.module_arg_spec, supports_tags=True)
    ...
    def exec_module(self, **kwargs):
        ...
        if (self.resource_group_name is not None and
            ...
            self.transformation_name is not None):
            self.results['transformations'] = self.format_item(self.get())
        return self.results
