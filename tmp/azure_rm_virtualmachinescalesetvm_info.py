  ...
  contains:
            ...
            console_screenshot_blob_uri:
              description:
                - >-
                  ...
                  **not** be set if boot diagnostics is currently enabled with
                  managed storage.
              returned: always
              type: str
              sample: null
        ...
        assigned_host:
          description:
            - >-
              ...
              associated with a dedicated host group that has automatic
        ...
        vm_size:
          description:
            - >-
              ...
              <br><br> The available VM sizes depend on region and availability
              set. For a list of available sizes use these APIs:  <br><br> [List
              all available virtual machine sizes in an availability
            ...
            create_option:
              description:
                - >-
                  ...
                  virtual machine.<br><br> **FromImage** \u2013 This value is
    ...
    os_profile:
      ...
      contains:
        computer_name:
          description:
            - >-
              Specifies the host OS name of the virtual machine. <br><br> This
        ...
        admin_username:
          description:
            - >-
              Specifies the name of the administrator account. <br><br> This
              property cannot be updated after the VM is created. <br><br>
        ...
        allow_extension_operations:
          description:
            - >-
              ...
              virtual machine. <br><br>This may only be set to False when no
    ...
    availability_set:
      description:
        - >-
          ...
          [Manage the availability of virtual
    ...
    boot_diagnostics:
      description:
        - >-
          Boot Diagnostics is a debugging feature which allows you to view
          Console Output and Screenshot to diagnose VM status. <br><br> You can
      ...
      contains:
        console_screenshot_blob_uri:
          description:
            - >-
              The console screenshot blob URI. <br><br>NOTE: This will **not**
        ...
        serial_console_log_blob_uri:
          description:
            - >-
              The serial console log blob Uri. <br><br>NOTE: This will **not**
              be set if boot diagnostics is currently enabled with managed
              storage.
          returned: always
          type: str
        ...
        status:
          description:
            - >-
              The boot diagnostics status information for the VM. <br><br> NOTE:
      ...
      contains:
        ...
        instance_view:
          ...
          contains:
              ...
              contains:
                console_screenshot_blob_uri:
                  description:
                    - >-
                      The console screenshot blob URI. <br><br>NOTE: This will
                      **not** be set if boot diagnostics is currently enabled
                ...
                status:
                  description:
                    - >-
                      ...
                      <br><br> NOTE: It will be set only if there are errors
            ...
            assigned_host:
              description:
                - >-
                  Resource id of the dedicated host, on which the virtual
                  machine is allocated through automatic placement, when the
                  virtual machine is associated with a dedicated host group that
                  has automatic placement enabled. <br><br>Minimum api-version:
                  2020-06-01.
              returned: always
              type: str
              sample: null
            ...
            vm_size:
              description:
                - >-
                  ...
                  APIs:  <br><br> [List all available virtual machine sizes in
                  an availability
                  set](https://docs.microsoft.com/rest/api/compute/availabilitysets/listavailablesizes)
                  <br><br> [List all available virtual machine sizes in a
                  region](https://docs.microsoft.com/rest/api/compute/virtualmachinesizes/list)
            ...
            os_disk:
              description:
                - >-
                  ...
                  the virtual machine. <br><br> For more information about
                ...
                create_option:
                  description:
                    - >-
                      ...
                      created.<br><br> Possible values are:<br><br> **Attach**
                      \u2013 This value is used when you are using a specialized
                ...
                disk_mbps_read_write:
                  description:
                    - >-
                      ...
                      disk when StorageAccountType is UltraSSD_LRS. Returned
                      only for VirtualMachine ScaleSet VM disks. Can be updated
                      only via updates to the VirtualMachine Scale Set.
                  returned: always
                  type: integer
                  sample: null
        additional_capabilities:
            ...
            allow_extension_operations:
              description:
                - >-
                  ...
                  the virtual machine. <br><br>This may only be set to False
        ...
        availability_set:
          description:
            - >-
              ...
              Azure](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-planned-maintenance?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)
              <br><br> Currently, a VM can only be added to availability set at
              creation time. An existing VM cannot be added to an availability
              set.
          returned: always
          type: dict
          sample: null
        ...
        model_definition_applied:
          description:
            - >-
              Specifies whether the model applied to the virtual machine is the
              model of the virtual machine scale set or the customized model for
              the virtual machine.
          returned: always
          type: str
          sample: null
