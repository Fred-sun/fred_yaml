...
options:
  ...
  state:
    description:
      ...
      - >-
        Use C(present) to create or update an Profile and C(absent) to delete
        it.
    default: present
    choices:
      - absent
...
class AzureRMProfile(AzureRMModuleBaseExt):
    def __init__(self):
        self.module_arg_spec = dict(
            ...
            strong_ids=dict(
                type='list',
                disposition='/strong_ids',
                elements='dict',
                options=dict(
                    key_property_names=dict(
                        type='list',
                        disposition='key_property_names',
                        required=True,
                        elements='str'
                    ),
                    strong_id_name=dict(
                        type='str',
                        disposition='strong_id_name',
                        required=True
                    ),
                    display_name=dict(
                        type='dictionary',
    ...
    def create_update_resource(self):
        try:
            response = self.mgmt_client.profiles.create_or_update(resource_group_name=self.resource_group_name,
    ...
    def delete_resource(self):
        try:
            response = self.mgmt_client.profiles.delete(resource_group_name=self.resource_group_name,
                                                        hub_name=self.hub_name,
                                                        profile_name=self.profile_name,
